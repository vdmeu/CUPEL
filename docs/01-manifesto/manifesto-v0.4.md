...
AI can now pass professional exams that once took humans years to master. For example, a 2025 NYU Stern and Goodfin study found that leading models scored above 79% on the CFA Level III—the hardest part of that certification. Similar results are emerging in medicine, engineering, and law.
...
When everyone optimizes for the measure, the measure stops working. That's Goodhart's Law in action.
...
Skills assessment
Digital credentials
Content authenticity tracking (content credentials)
...
We don't need new systems. We need a common layer that connects the ones we already have, making it possible to recognize human expertise in an AI-saturated world.
...
As AI produces more professional work, we must be able to tell what was done by humans and by machines. Knowing when a human was genuinely in the loop—making real decisions, not just approving AI output—matters as much as the final result. That's not just ethical—it's becoming law, as seen in the EU AI Act's human oversight requirements (Article 14) and provenance rules (Article 50).

AI performance must come with context.
AI can perform, but we need transparency about the process behind the output—the iterations, the human checkpoints, the decisions made along the way—not just the final result. Who guided it and who is responsible must be traceable.
...
What Cupel offers
Cupel is an open framework for tracing professional competence.
...
Cupel is designed for selective disclosure. Participation is voluntary, and individuals choose what signals to share and with whom. The framework has no central registry of people.
...
Practitioners and employers: Share your experience of what genuine competence looks like in your field. Your insight is essential.

Documentation and source: github.com/vdmeu/CUPEL
Contact: contact@cupel.foundation
